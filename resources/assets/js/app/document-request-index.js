$(function () {
    ...
    if (dtDocumentTable.length) {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        actionsHtml += `<button class="btn btn-sm btn-icon hitech-action-icon edit-record" data-id="${full['id']}" data-bs-toggle="modal" data-bs-target="#actionModal" title="Review"><i class="bx bx-edit"></i></button>`;

                        if (full['status'] === 'Pending') {
                            actionsHtml += `<button class="btn btn-sm btn-icon hitech-action-icon text-success quick-approve" data-id="${full['id']}" title="Quick Approve"><i class="bx bx-check-circle"></i></button>`;
                            actionsHtml += `<button class="btn btn-sm btn-icon hitech-action-icon text-danger quick-reject" data-id="${full['id']}" title="Quick Reject"><i class="bx bx-x-circle"></i></button>`;
                        }
        ...
        // Status Toggle Logic (Segmented Control)
