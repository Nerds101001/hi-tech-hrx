...

        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<a href="javascript:;" class="icon-sophisticated edit-record" data-id="${full['id']}" data-bs-toggle="modal" data-bs-target="#modalAddOrUpdateHoliday" title="Edit"><i class="bx bx-edit"></i></a>` +
