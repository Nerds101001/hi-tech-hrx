...
<div class="col-xl-3 col-md-6 col-sm-6 animate__animated animate__fadeInUp" style="animation-delay: {{ $animationDelay }}">
    <div class="hitech-stat-card dashboard-variant h-100 {{ $link ? 'cursor-pointer' : '' }}" {{ $link ? 'onclick="window.location.href=\'' . $link . '\'"' : '' }}>
        ...
        <div class="stat-card-body">
            <div class="stat-card-label text-uppercase mb-1" style="font-size: 0.72rem; font-weight: 700; color: #94a3b8; letter-spacing: 0.05em;">
                {{ $title }}
            </div>
            <h3 class="stat-card-value mb-1" style="font-size: 1.8rem; font-weight: 800; color: #1e293b; line-height: 1;">
                {{ $value }}
            </h3>
