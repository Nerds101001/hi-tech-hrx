        ...
        <div class="content">
          ...
          <div class="features">
            <div class="feature-item">
              ...
              <p>A secure reset link will be sent to your registered email address</p>
            </div>
            <div class="feature-item">
              <i class="bx bx-shield-quarter"></i>
              <p>Password reset links expire within 60 minutes for your security</p>
            </div>
            <div class="feature-item">
              <i class="bx bx-lock-alt"></i>
              <p>Your account is protected with end-to-end encryption</p>
            </div>
          </div>
        </div>
      ...
      <div class="form-panel animate__animated animate__fadeInRight" style="animation-delay: 0.1s">
        ...
        <div class="form-inner">
          ...
          <div class="form-header">
            ...
            <p class="login-subtitle">Enter your registered email address and we&apos;ll send you a secure password reset link.</p>
          </div>
