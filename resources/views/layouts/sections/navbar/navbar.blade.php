    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown ms-3">
            <a class="nav-link dropdown-toggle hide-arrow p-0 align-items-center d-flex gap-2" href="javascript:void(0);" data-bs-toggle="dropdown" style="border: 1px solid rgba(0,0,0,0.05); border-radius: 50px; padding: 0.25rem 0.75rem !important; background-color: #f8f9fa;">
                <div class="avatar avatar-sm rounded-circle d-flex align-items-center justify-content-center" style="background-color: #0f766e; color: white;">
                    ...
                    @else
                        <span class="fw-semibold" style="font-size: 0.8rem;">{{ $initial }}</span>
                    @endif
                </div>
                <div class="d-none d-md-flex flex-column text-start justify-content-center" style="line-height: 1.1;">
                    <span class="fw-bold text-heading" style="font-size: 0.75rem;">{{ Auth::user() ? Auth::user()->getFullName() : 'Demo User' }}</span>
                    <span class="text-muted" style="font-size: 0.65rem;">{{ Auth::user() ? Auth::user()->roles()->first()->name : 'Employee' }}</span>
                </div>
