...
<div class="px-4">
    ...
    <x-hero-banner 
      ...
      subtitle="Define and manage job roles across departments."
      icon="bx-briefcase"
      gradient="primary"
    />
    ...
    <div class="hitech-card animate__animated animate__fadeInUp mt-6" style="animation-delay: 0.1s">
        <div class="hitech-card-header border-bottom">
            <div class="d-flex align-items-center gap-3">
                <h5 class="title mb-0">Designation List</h5>
                <span class="badge search-light-badge rounded-pill px-3">Role Map</span>
            </div>
        </div>
        ...
        <div class="card-body p-4 border-bottom">
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <div class="search-wrapper-hitech" style="width: 400px;">
                    ...
                    <input type="text" class="form-control" placeholder="Search designation name or code..." id="customSearchInput">
                ...
                {{-- Add New Action --}}
                <button type="button" class="btn btn-hitech shadow-sm px-4 add-new-designation" data-bs-toggle="modal"
                        data-bs-target="#modalAddOrUpdateDesignation">
                    <i class="bx bx-plus me-1"></i>Add Designation
                </button>

                {{-- Export Icon --}}
                <button type="button" class="btn btn-hitech-icon shadow-sm" onclick="exportData()" title="Export Designations">
                    <i class="bx bx-download fs-5"></i>
                </button>
            </div>
        </div>
        <div class="card-datatable table-responsive p-0">
            <table class="datatables-designations table table-hover border-top mb-0">
        <thead>
        <tr>
          <th>@lang('')</th>
          <th>@lang('Id')</th>
