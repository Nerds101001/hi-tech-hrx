...
<div class="modal-body pt-5">
  <div class="row g-4">
    <div class="col-md-12">
      ...
      <input class="form-control" name="question" type="text" value="{{ $customQuestion->question }}" placeholder="Enter interview question" required>
    </div>
    <div class="col-md-12">
...
<div class="modal-footer border-top pt-4">
  ...
  <button type="submit" class="btn btn-primary px-6">Update Question</button>
</div>
</form>
