...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <x-hero-banner 
      ...
      subtitle="Visualize the structural layout and reporting lines of your company."
      icon="bx-sitemap"
      gradient="teal"
    />

    {{-- CHART SECTION --}}
    <div class="hitech-card animate__animated animate__fadeInUp mt-4" style="animation-delay: 0.1s; position: relative; min-height: 700px; display: flex; flex-direction: column;">
      
      {{-- Chart Toolbar --}}
      <div class="hitech-card-header border-bottom p-4">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 w-100">
            <div class="d-flex align-items-center gap-3">
                <h5 class="title mb-0">Interactive Structure</h5>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="btn-group shadow-sm">
                    <button class="btn btn-white btn-sm px-3 border" id="zoom-in" title="Zoom In"><i class="bx bx-plus"></i></button>
                    <button class="btn btn-white btn-sm px-3 border" id="zoom-reset" title="Reset Zoom">100%</button>
                    <button class="btn btn-white btn-sm px-3 border" id="zoom-out" title="Zoom Out"><i class="bx bx-minus"></i></button>
                </div>
                
                {{-- Search --}}
                <div class="search-wrapper-hitech" style="width: 350px;">
                ...
                <button class="btn btn-hitech-icon shadow-sm" id="fullscreen-toggle" title="Toggle Fullscreen">
      ...
      <div id="userCardPopover" class="details-drawer shadow-lg d-none">
          <div class="drawer-header p-4 pb-0 text-center">
              ...
              <div id="pop-designation" class="text-primary small fw-semibold">...</div>
          </div>
          ...
          <div class="drawer-footer p-4 pt-0">
              <button class="btn btn-primary w-100 rounded-pill py-2" id="pop-view-profile">View Full Profile</button>
          </div>
      </div>
    </div>
</div>
