        ...
        @if($addonService->isAddonEnabled(ModuleConstants::PAYROLL))
          ...
          <div class="tab-pane fade animate__animated animate__fadeIn" id="payrollSettings" role="tabpanel">
            <form action="{{ route('settings.updatePayrollSettings') }}" method="POST">
              ...
              <div class="hitech-card mb-6">
                <div class="hitech-card-header">
                  <h5 class="title m-0">Payroll Settings</h5>
                </div>
                <div class="card-body pt-4">
                  <div class="row g-6">
                    <!-- Payroll Frequency -->
            ...
            <div class="hitech-card mt-6">
              <div class="hitech-card-header d-flex justify-content-between align-items-center">
                <h5 class="title m-0"><i class="bx bx-adjust text-primary me-2"></i> @lang('Payroll Adjustments')</h5>
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover table-borderless mb-0">
                      ...
                      @foreach($payrollAdjustments as $adjustment)
                        <tr>
                          <td><span class="fw-medium">{{ $adjustment->name }}</span></td>
                          <td>{{ $adjustment->code }}</td>
                          <td>
                            @if($adjustment->type === 'benefit')
                              <span class="badge badge-hitech bg-label-success">@lang('Benefit')</span>
                            @else
                              <span class="badge badge-hitech bg-label-danger">@lang('Deduction')</span>
                            @endif
                          </td>
                          <td>
                            @if($adjustment->applicability === 'global')
                              <span class="badge badge-hitech bg-label-info">@lang('Global')</span>
                            @else
                              <span class="badge badge-hitech bg-label-secondary">@lang('Employee-Specific')</span>
                            @endif
                          </td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <!-- Edit Button -->
                              <a href="#" class="btn btn-icon btn-sm btn-label-warning rounded-pill me-2 editPayrollAdjustment"
            ...
            @if($settings->is_helper_text_enabled)
              <div class="alert alert-primary alert-dismissible mt-5 shadow-sm border-0" role="alert" style="background:rgba(13,110,253,0.1); color:#0d6efd;">
                <h6 class="alert-heading fw-bold mb-1"><i class="bx bx-info-circle me-1"></i> What is Payroll Adjustments?</h6>
                <p class="mb-0 small opacity-75">Payroll adjustments are additional benefits or deductions that are added to the
                  employee's
