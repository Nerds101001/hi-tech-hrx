...
@section('vendor-style')
  ...
  <style>
    ...
    body {
      background: radial-gradient(circle at top right, rgba(0, 128, 0, 0.12), transparent),
...
<div class="apply-page pb-20">
  ...
  <nav class="navbar navbar-expand-lg navbar-glass sticky-top py-4">
    <div class="container d-flex justify-content-between">
      ...
      <a href="{{ route('job.requirement', [$job->code, $currantLang]) }}" class="btn btn-label-secondary btn-sm rounded-pill">
  ...
  {{-- Subtle Hero Blur --}}
  <div style="height: 250px; background: linear-gradient(135deg, rgba(0, 128, 128, 0.1), rgba(0, 128, 128, 0.05));">
        ...
        <div class="glass-pannel">
          <form action="{{ route('job.apply.data', $job->code) }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="mb-12">
              ...
              <div class="row g-6">
                ...
                <div class="col-md-12">
                  ...
                  <textarea name="cover_letter" class="form-control" rows="4" placeholder="Tell us why you are the perfect candidate..."></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="mt-8 pt-8 border-top d-flex justify-content-between align-items-center">
              ...
              <button type="submit" class="btn btn-primary btn-lg px-12 rounded-pill shadow-lg">
