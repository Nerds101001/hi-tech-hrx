...
<div class="layout-full-width animate__animated animate__fadeIn">
  <div class="d-flex justify-content-between align-items-center mb-6 px-4">
    <h3 class="mb-0 fw-bold text-heading" style="font-size: 1.5rem;">Edit Job: {{ $job->title }}</h3>
  ...
  <div class="px-4">
    <form action="{{ route('job.update', $job->id) }}" method="post" class="needs-validation" novalidate>
    @csrf
    @method('PUT')
    <div class="row g-6">
      <div class="col-md-6">
          ...
          <div class="card-body pt-5">
            <div class="row g-4">
              <div class="col-12">
                ...
                <input type="text" name="title" class="form-control" required placeholder="Enter job title" value="{{ $job->title }}">
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="number" name="position" class="form-control" required placeholder="Enter number of positions" value="{{ $job->position }}">
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="start_date" class="form-control flatpickr-date" autocomplete="off" value="{{ $job->start_date }}">
              </div>
              <div class="col-md-6">
                <label class="form-label fw-bold small text-muted text-uppercase mb-2">End Date</label>
                <input type="text" name="end_date" class="form-control flatpickr-date" autocomplete="off" value="{{ $job->end_date }}">
              </div>
              <div class="col-12">
                <label class="form-label fw-bold small text-muted text-uppercase mb-2">Skills <span class="text-danger">*</span></label>
                <input id="skill" name="skill" class="form-control" required placeholder="Enter skills" value="{{ $job->skill }}">
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="d-flex flex-column gap-3">
                  <div class="form-check custom-option custom-option-basic">
                    <label class="form-check-label custom-option-content" for="check-gender">
                      <input class="form-check-input" type="checkbox" name="applicant[]" value="gender" id="check-gender" {{ in_array('gender', $job->applicant) ? 'checked' : '' }}>
                  ...
                  <div class="form-check custom-option custom-option-basic">
                    <label class="form-check-label custom-option-content" for="check-dob">
                      <input class="form-check-input" type="checkbox" name="applicant[]" value="dob" id="check-dob" {{ in_array('dob', $job->applicant) ? 'checked' : '' }}>
                      <span class="custom-option-header">
                  ...
                  <div class="form-check custom-option custom-option-basic">
                    <label class="form-check-label custom-option-content" for="check-address">
                      <input class="form-check-input" type="checkbox" name="applicant[]" value="address" id="check-address" {{ in_array('address', $job->applicant) ? 'checked' : '' }}>
                      <span class="custom-option-header">
                ...
                <div class="d-flex flex-column gap-3">
                  <div class="form-check custom-option custom-option-basic">
                    <label class="form-check-label custom-option-content" for="check-profile">
                      <input class="form-check-input" type="checkbox" name="visibility[]" value="profile" id="check-profile" {{ in_array('profile', $job->visibility) ? 'checked' : '' }}>
                      <span class="custom-option-header">
                  ...
                  <div class="form-check custom-option custom-option-basic">
                    <label class="form-check-label custom-option-content" for="check-resume">
                      <input class="form-check-input" type="checkbox" name="visibility[]" value="resume" id="check-resume" {{ in_array('resume', $job->visibility) ? 'checked' : '' }}>
                      <span class="custom-option-header">
                  ...
                  <div class="form-check custom-option custom-option-basic">
                    <label class="form-check-label custom-option-content" for="check-letter">
                      <input class="form-check-input" type="checkbox" name="visibility[]" value="letter" id="check-letter" {{ in_array('letter', $job->visibility) ? 'checked' : '' }}>
                      <span class="custom-option-header">
                  ...
                  <div class="form-check custom-option custom-option-basic">
                    <label class="form-check-label custom-option-content" for="check-terms">
                      <input class="form-check-input" type="checkbox" name="visibility[]" value="terms" id="check-terms" {{ in_array('terms', $job->visibility) ? 'checked' : '' }}>
                      <span class="custom-option-header">
                    ...
                    <div class="col-md-6">
                      <div class="form-check custom-option custom-option-basic">
                        <label class="form-check-label custom-option-content" for="custom_question_{{ $question->id }}">
                          <input class="form-check-input" type="checkbox" name="custom_question[]" value="{{ $question->id }}" id="custom_question_{{ $question->id }}" @if($question->is_required == 'yes') required @endif {{ in_array($question->id, $job->custom_question) ? 'checked' : '' }}>
                          <span class="custom-option-header">
      ...
      <div class="col-12 text-end mb-6">
        ...
        <button type="submit" class="btn btn-primary px-6">Update Job</button>
      </div>
    </div>
    </form>
  </div>
