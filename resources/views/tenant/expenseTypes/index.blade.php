...
<div class="row g-6 px-4">
  ...
  <div class="col-lg-12">
    <x-hero-banner
      title="Expense Type Management"
      subtitle="Define and manage different types of expenses for employee claims"
      icon="bx-wallet"
      gradient="info"
    />
  </div>
  ...
  <div class="col-12">
    <div class="hitech-card animate__animated animate__fadeInUp" style="animation-delay: 0.4s">
      <div class="hitech-card-header p-sm-5 p-4 border-bottom">
        <div class="row align-items-center g-4">
          ...
          <div class="col-md-5 d-flex align-items-center justify-content-end gap-3">
            <button type="button" class="btn btn-hitech add-new px-4 d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#modalAddOrUpdateExpenseType">
      ...
      <div class="card-datatable table-responsive p-0">
        <table class="datatables-expenseTypes table table-hover border-top mb-0">
          <thead>
            <tr>
              <th>@lang('')</th>
              <th>@lang('Id')</th>
