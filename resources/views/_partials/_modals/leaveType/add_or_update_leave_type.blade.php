                                ...
                                <div class="d-flex align-items-center justify-content-between p-3 bg-glass-teal border-teal-subtle">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="small text-white-50 mt-1">Medical certificate or proof needed</div>
                                        </div>
                                    </div>
                                    <div class="form-check form-switch-awesome mb-0">
                                        <input class="form-check-input hitech-awesome-toggle" type="checkbox" id="isProofRequiredToggle">
