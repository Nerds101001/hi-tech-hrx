      ...
      <div class="modal-body modal-body-hitech">
        <form id="contactInfoForm" action="{{ route('employees.updateBasicInfo') }}" method="POST">
          ...
          <div class="row g-3 mb-5">
            <div class="col-md-6">
              <label class="form-label-hitech" for="ci_email">Personal Email <span class="text-danger">*</span></label>
              <input type="email" class="form-control form-control-hitech" id="ci_email" name="email" value="{{ $user->email }}" required />
            </div>
            <div class="col-md-6">
              <label class="form-label-hitech" for="ci_phone">Primary Phone <span class="text-danger">*</span></label>
