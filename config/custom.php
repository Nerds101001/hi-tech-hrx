...
return [
  'custom' => [
    ...
    'myTheme' => 'theme-premium', // Options[String]: theme-default(default), theme-bordered, theme-semi-dark
    ...
    'navbarType' => 'fixed', // options[String]: 'sticky', 'static', 'hidden' (Only for vertical Layout)
    ...
    'menuCollapsed' => false, // options[Boolean]: false(default), true // Menu Collapsed , (Only for vertical Layout)
