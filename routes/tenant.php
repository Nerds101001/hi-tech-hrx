...
use App\Http\Controllers\tenant\SiteAttendanceController;
...
Route::middleware([
  ...
  'role:admin|hr|manager'
    ...
    Route::prefix('siteattendance')->name('siteattendance.')->group(function () {
      ...
      Route::get('indexAjax', [SiteAttendanceController::class, 'indexAjax'])->name('indexAjax');
    });
    ...
    Route::prefix('employees')->group(function () {
      Route::name('employees.')->group(function() {
        ...
        Route::get('addOrUpdateBankAccount', fn() => redirect()->route('employees.index'))->name('addOrUpdateBankAccount.get');
        ...
        Route::get('updateBasicInfo', fn() => redirect()->route('employees.index'))->name('updateBasicInfo.get');
      ...
      Route::name('onboarding.')->prefix('onboarding')->group(function() {
          Route::get('review-center', [EmployeeController::class, 'reviewCenter'])->name('reviewCenter');
    ...
    Route::middleware(['role:hr|admin'])->prefix('asset-management')->name('assets.')->group(function () {
      ...
      Route::get('getListAjax', [AssetController::class, 'getListAjax'])->name('getListAjax');
    ...
    // My Assets (Employee) - Moved outside the admin|hr|manager group to allow field_employee access
    Route::middleware(['web', 'auth', 'role:field_employee|manager|admin|hr'])->prefix('my-assets')->name('myAssets.')->group(function () {
    ...
    Route::middleware(['role:admin|hr'])->prefix('asset-categories')->name('assetCategories.')->group(function () {
        Route::get('', [AssetCategoryController::class, 'index'])->name('index');
        Route::get('list/ajax', [AssetCategoryController::class, 'getListAjax'])->name('list.ajax');
